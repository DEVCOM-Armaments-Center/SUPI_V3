...
Design change history for the sUPI mechanical interface. Entries are reproduced verbatim from the
source document; part nomenclature in the Part column was added for readability and is not part of
the original text.
...
**`13122514` before and after the v3.2 change.** Labels and figure placement are as given in the
source document.
